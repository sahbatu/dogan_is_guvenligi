...
import { Plus, Pencil, Trash2, Package, Banknote } from 'lucide-react'
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="mt-8 overflow-x-auto rounded-2xl border border-navy-900/5 bg-white shadow-sm">
